...
#         global user_answer
#         qustion =  'What screen size you prefer?'  
#         answers = ['less than 7 inch', 'more than 7 inch']
#         self.S = user_input()
#         self.declare(Fact(Screen_s =self.S))
#         user_answer = None
...
#         global output
#         id=132
#         output=(r'http://127.0.0.1:8000/techcart/products/{}/'.format(id))
#         id=None
...
#         #semi_output = 'Amazon ML or Microsoft Azura or Google AI or IBM Watson'
#         output={'Amazon':r'https://aws.amazon.com/machine-learning/','Microsoft Azurar':r'https://azure.microsoft.com/en-us/','Google AI':r'https://ai.google/','IBM Watson':r'https://www.ibm.com/watson'}
#         #output=semi_output.split('or')
...
#         output={'Amazon':r'https://aws.amazon.com/machine-learning/','Microsoft Azurar':r'https://azure.microsoft.com/en-us/','Google AI':r'https://ai.google/'}

#     @Rule(Fact(iadity='2'))
#     def MLOutput5(self):
#         global output
#         output={'Amazon':r'https://aws.amazon.com/machine-learning/','Microsoft Azurar':r'https://azure.microsoft.com/en-us/'}
...
#     def MLOutput8(self):
#         global output
#         output = {'we recommend this site for more information':r'https://buy.hpe.com/us/en/'}
...
#     global user_answer
#     time.sleep(500/1000)
#     if user_answer != None or user_answer == "terminate":
#         return user_answer
#     return user_input()
